...
class InsertActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 카메라 접속
        val camera = findViewById<Button>(R.id.insertMoveCamera)
        camera.setOnClickListener{
            Toast.makeText(this, "카메라", Toast.LENGTH_LONG).show()
            GetCamera()
        }
        // 앨범 접속
        val album = findViewById<Button>(R.id.insertMoveAlbum)
        ...
        radio.setOnCheckedChangeListener { group, btn ->
            when(btn){
                R.id.insertRadio1 -> {
                    Log.d("확인!!!!!", "아침")
                    category = 1
        ...
        // 데이터 저장
        var menu = findViewById<EditText>(R.id.insertMenu)
